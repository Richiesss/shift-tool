...
FONT_DATA   = Font(size=7, bold=True)
FONT_NOTE   = Font(size=7, bold=True)
FONT_LEAVE  = Font(color="166534", bold=True, size=7)   # 有給：緑
FONT_FT_OFF   = Font(color="DC2626", bold=True, size=7)   # 正社員希望休：赤
FONT_CELL_NOTE = Font(color="78350F", bold=True, size=7)  # セルコメント：濃黄文字
FONT_OFF    = Font(color="9CA3AF", size=7, bold=True)
