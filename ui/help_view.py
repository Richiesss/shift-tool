...
<ul>
  ...
  <li><b>勤務時間帯</b> — 朝食専任 / ディナー専任 / どちらでも を設定します。<br>
    正社員はどちらでも可（毎回希望入力不要）、アルバイト/パートは希望に従います。</li>
  <li><b>習熟度</b> — ホール・キッチンそれぞれに設定します。<br>
    <b>リーダー</b> ≫ <b>ベテラン</b>（熟練者カウント対象）≫ <b>メンバー</b> ≫ <b>ビギナー</b></li>
  <li><b>固定シフト（アルバイト/パートのみ）</b> — 毎週決まった曜日・時間帯に出るスタッフは固定パターンを設定すると希望入力を省略できます。</li>
...
<ul>
  ...
  <li><b>優先度設定</b> — 人件費最小化・アルバイト/パート希望充当・人員バランス均等化・深夜勤務分散（アルバイト/パートのみ）を「低/中/高」で調整できます。</li>
  <li><b>自動生成の基本ルール</b>:
    <ul>
      <li>正社員の掛け持ち禁止（朝食とディナーの両方に出勤不可）</li>
      <li>朝食はアルバイト/パート優先（アルバイト/パートだけで充足する場合は正社員はアサインされません）</li>
      <li>ディナーは正社員優先（正社員だけで充足する場合はアルバイト/パートはアサインされません）</li>
